...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashState&&(identical(other.splashStatus, splashStatus) || other.splashStatus == splashStatus));
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? splashStatus = null,}) {
  return _then(_self.copyWith(
splashStatus: null == splashStatus ? _self.splashStatus : splashStatus // ignore: cast_nullable_to_non_nullable
as SplashStatus,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SplashStatus splashStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.splashStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SplashStatus splashStatus)  $default,) {final _that = this;
switch (_that) {
case _SplashState():
return $default(_that.splashStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SplashStatus splashStatus)?  $default,) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.splashStatus);case _:
  return null;
...
class _SplashState implements SplashState {
  const _SplashState({this.splashStatus = SplashStatus.initial});
  

@override@JsonKey() final  SplashStatus splashStatus;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashState&&(identical(other.splashStatus, splashStatus) || other.splashStatus == splashStatus));
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? splashStatus = null,}) {
